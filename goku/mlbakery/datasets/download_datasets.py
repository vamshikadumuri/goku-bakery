...
def fetch_aya_redteaming():
    load_hf_dataset("CohereForAI/aya_redteaming", DATASETS_DIR / "aya_redteaming")

def fetch_jbb_behaviors():
    load_hf_dataset("JailbreakBench/JBB-Behaviors", DATASETS_DIR / "jbb_behaviors")

def fetch_forbidden_questions():
    load_hf_dataset("TrustAIRLab/forbidden_question_set", DATASETS_DIR / "forbidden_questions")
...
def fetch_beaver_tails():
    load_hf_dataset("PKU-Alignment/BeaverTails", DATASETS_DIR / "beaver_tails")

def fetch_salad_bench():
    load_hf_dataset("walledai/SaladBench", DATASETS_DIR / "salad_bench")

def fetch_simple_safety_tests():
    load_hf_dataset("Bertievidgen/SimpleSafetyTests", DATASETS_DIR / "simple_safety_tests")

def fetch_sorry_bench():
    load_hf_dataset("sorry-bench/sorry-bench-202503", DATASETS_DIR / "sorry_bench")
...
def fetch_pku_safe_rlhf():
    load_hf_dataset("PKU-Alignment/PKU-SafeRLHF", DATASETS_DIR / "pku_safe_rlhf")
